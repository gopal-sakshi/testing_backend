...
let emp1 = { type: "Employee", employeecode: 6415, name: "Rahul" };
AllowRestrictedArea(emp1);
let vis1 = { type: "Visitor", visitorcode: 34, name: "Sachin" };
AllowRestrictedArea(vis1);
let cont1 = { type: "Contractor", contractorcode: 0o7, name: "Saurav" };
