...
// HOW TO RUN
    ...
    // node fork23.js
    // open localhost:3069/compute ----------------------------> it takes very long time to respond... server wont accept any new requests
    // node fork24.js ====> open localhost:3070/compute -------> it takes very long time to respond... but server is not blocked, it can accept other requests
...
server.on('request', (req, res) => {
  if (req.url === '/compute') {
    ...
    res.end('takku mani vachindaa response');
